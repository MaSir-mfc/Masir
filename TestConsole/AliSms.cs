...
namespace TestConsole
{
    public class AliSms
    {
        ...
        public SendSmsResponse sendSms(string mobile, string signName, string tempCode, string param)
        {
            ...
            try
            {
                ...
                request.PhoneNumbers = mobile;// "15000000000";
                //必填:短信签名-可在短信控制台中找到
                request.SignName = signName;// "云通信";
                //必填:短信模板-可在短信控制台中找到
                request.TemplateCode = tempCode;// "SMS_1000000";
                //可选:模板中的变量替换JSON串,如模板内容为"亲爱的${name},您的验证码为${code}"时,此处的值为
                request.TemplateParam = param;// "{\"customer\":\"123\"}";
        ...
        //public SendBatchSmsResponse sendSms()
        //{
        //    IClientProfile profile = DefaultProfile.GetProfile("cn-hangzhou", key, secret);
        //    DefaultProfile.AddEndpoint("cn-hangzhou", "cn-hangzhou", product, domain);
